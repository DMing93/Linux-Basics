...
```c 
extern static //链接属性
short int char long double float//一般内置类型
struct union enum // 高级类型
if else switch case default while for continue break do goto //条件控制
auto signed unsigned sizeof void volatile const register return typedef    
```
